...
build-debug-applications:
    tools/devenv/linux/run.sh cmake --build --preset linux-debug --target ksj_cli ksj_gateway ksj_recon ksj_research ksj_viewer

[windows]
build-debug-applications:
    powershell.exe -NoProfile -ExecutionPolicy Bypass -File ./tools/devenv/windows/run.ps1 cmake --build --preset windows-vs2022-debug --target ksj_cli ksj_gateway ksj_recon ksj_research ksj_viewer

# Incrementally build all installed applications in release configuration.
[linux]
build-release-applications:
    tools/devenv/linux/run.sh cmake --build --preset linux-release --target ksj_cli ksj_gateway ksj_recon ksj_research ksj_viewer

[windows]
build-release-applications:
    powershell.exe -NoProfile -ExecutionPolicy Bypass -File ./tools/devenv/windows/run.ps1 cmake --build --preset windows-vs2022-release --target ksj_cli ksj_gateway ksj_recon ksj_research ksj_viewer
...
smoke-release-install:
    powershell.exe -NoProfile -ExecutionPolicy Bypass -File ./tools/checks/windows/smoke_release_install.ps1 -BuildBinDirectory ./out/build/windows-vs2022-release/bin -InstallBinDirectory ./out/install/windows-vs2022-release/bin
