...
Write-KSpaceJetNote "pre-commit: staged format/local-Markdown-link/generated-file/CMake checks"
...
Write-KSpaceJetNote "pre-push smoke: run .\tools\devenv\windows\run.ps1 just pre-push manually for local smoke"
