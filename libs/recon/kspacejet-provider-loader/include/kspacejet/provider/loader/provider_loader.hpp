...
/**
 * A copied digest advertised by a Provider ABI descriptor.
 *
...
struct ProviderLoadOptions {
  ...
  std::string host_build_id{"KSpaceJet ProviderLoader"};
...
public:
  ...
  [[nodiscard]] const ksj_provider_api* api() const noexcept;
...
/**
 * Move-only value wrapper around one validated, in-process Provider ABI module.
 *
...
public:
   ...
   * validates the returned descriptor and lifecycle table.
   */
