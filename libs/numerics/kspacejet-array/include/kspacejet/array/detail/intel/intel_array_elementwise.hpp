...
#define KSJ_ARRAY_INTEL_ELEMENTWISE_DECLS(T)                                                                           \
...
KSJ_ARRAY_INTEL_ELEMENTWISE_DECLS(ksj::base::f32);
KSJ_ARRAY_INTEL_ELEMENTWISE_DECLS(ksj::base::f64);
KSJ_ARRAY_INTEL_ELEMENTWISE_DECLS(ksj::base::cf32);
KSJ_ARRAY_INTEL_ELEMENTWISE_DECLS(ksj::base::cf64);

#undef KSJ_ARRAY_INTEL_ELEMENTWISE_DECLS
...
[[nodiscard]] bool bitwise_and(VectorView<const ksj::base::u32> lhs, VectorView<const ksj::base::u32> rhs,
                               VectorView<ksj::base::u32> output);
[[nodiscard]] bool bitwise_not(VectorView<const ksj::base::u32> input, VectorView<ksj::base::u32> output);
...
template <typename LhsT, typename RhsT, typename OutputT>
[[nodiscard]] bool bitwise_and(VectorView<LhsT>, VectorView<RhsT>, VectorView<OutputT>) noexcept {
  return false;
}

template <typename InputT, typename OutputT>
[[nodiscard]] bool bitwise_not(VectorView<InputT>, VectorView<OutputT>) noexcept {
  return false;
}
