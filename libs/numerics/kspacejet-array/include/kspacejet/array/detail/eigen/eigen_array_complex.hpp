...
[[nodiscard]] bool rectangular_to_polar(VectorView<const ksj::base::cf32> input, VectorView<ksj::base::cf32> output);
[[nodiscard]] bool rectangular_to_polar(VectorView<const ksj::base::cf64> input, VectorView<ksj::base::cf64> output);
[[nodiscard]] bool rectangular_to_polar(MatrixView<const ksj::base::cf32> input, MatrixView<ksj::base::cf32> output);
[[nodiscard]] bool rectangular_to_polar(MatrixView<const ksj::base::cf64> input, MatrixView<ksj::base::cf64> output);
[[nodiscard]] bool rectangular_to_polar(ImageView<const ksj::base::cf32> input, ImageView<ksj::base::cf32> output);
[[nodiscard]] bool rectangular_to_polar(ImageView<const ksj::base::cf64> input, ImageView<ksj::base::cf64> output);
...
template <typename InputView, typename OutputView>
[[nodiscard]] bool rectangular_to_polar(InputView, OutputView) noexcept {
  return false;
}
