...
TEST(KSpaceJetReconModelArtifactJson, AdmissionRecordRoundTripsToStableCanonicalJson) {
...
TEST(KSpaceJetReconModelArtifactJson, RunRecordRoundTripsToStableCanonicalJson) {
...
TEST(KSpaceJetReconModelArtifactJson, AdmissionReasonUsesUnicodeCodePointSchemaBounds) {
  std::string reason;
...
TEST(KSpaceJetReconModelArtifactJson, StrictParsersRejectAmbiguousOrSchemaInvalidInput) {
...
TEST(KSpaceJetReconModelArtifactJson, SerializerRejectsRecordsOutsideThePublicParserResourceBounds) {
