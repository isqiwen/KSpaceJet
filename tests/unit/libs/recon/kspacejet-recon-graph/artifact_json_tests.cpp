...
[[nodiscard]] ksj::recon::ExecutionPlanSpec representative_execution_plan_spec() {
  return {
    ...
    .reorder_plans = {{.node_id = "reconstruct",
                       ...
                       .host_metadata_charged_bytes = 96U,
