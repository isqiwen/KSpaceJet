...
//
// Private lifecycle declarations for the noncartesian_adjoint_reconstruct
// Operator.
...
[[nodiscard]] const ksj_operator_descriptor& noncartesian_adjoint_reconstruct_descriptor() noexcept;
