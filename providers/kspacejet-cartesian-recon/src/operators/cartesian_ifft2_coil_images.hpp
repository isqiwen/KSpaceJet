...
//
// Private lifecycle declarations for the cartesian_ifft2_coil_images Operator.
...
[[nodiscard]] const ksj_operator_descriptor& cartesian_ifft2_coil_images_descriptor() noexcept;
